"""This module takes care of all the drawing on the screen.
It also opens and closes the screen."""
...
class VideoService:
    ...
    def draw_shape(self, shape):
        """Draws the given shape on the screen.

        Args:
            shape (Shapes): The shape to draw.
        """ 
        text = shape.get_text()
        x = shape.get_position().get_x()
        y = shape.get_position().get_y()
        font_size = shape.get_font_size()
        color = shape.get_color().to_tuple()
    ...
    def get_height(self):
        ...
        Returns:
            Height: The video screen's height.
        """
        return self._height
    ...
    def get_width(self):
        ...
        Returns:
            Width: The video screen's width.
        """
        return self._width
